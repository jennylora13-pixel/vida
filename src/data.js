...
export const SEMANA1 = [
  { n: "1º Dia", k: "s1d1",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • 1 concha de feijão (65g) • Brócolis e tomate à vontade • 80g de batata doce no vapor • Peixe ou frango 120g", lanche: "1 banana + 4 castanhas de caju", jantar: "Salada de folhas à vontade • Couve-flor e chuchu à vontade • 3 colheres de lentilha OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "2º Dia", k: "s1d2",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • Concha de lentilha (65g) • Couve-flor e chuchu à vontade • 80g de mandioca • Peixe ou frango 120g", lanche: "1 pera + 2 castanhas do Pará", jantar: "Salada de folhas à vontade • Brócolis e tomate • 1 concha de feijão (65g) OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "3º Dia", k: "s1d3",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • Repolho e abobrinha à vontade • 80g de inhame • Peixe ou frango 120g", lanche: "1 kiwi + 8 amêndoas", jantar: "Salada de folhas à vontade • Beringela com pimentão • 3 colheres de grão de bico (65g) OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  ...
  { n: "5º Dia", k: "s1d5",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • 1 ovo • 150g de repolho e abobrinha • 80g de mandioca • Peixe ou frango 120g", lanche: "1 kiwi + 5 castanhas de caju", jantar: "Salada de folhas • 150g de couve-flor e chuchu • 1 concha de feijão (65g) OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "6º Dia", k: "s1d6",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá verde", almoco: "Salada de folhas à vontade • Concha de feijão (65g) • Couve-flor e chuchu à vontade • 80g de quinoa • Peixe ou frango 120g", lanche: "1 pera + 2 castanhas do Pará", jantar: "Salada de folhas • Brócolis com tomate à vontade • 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "7º Dia", k: "s1d7",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • Repolho e abobrinha à vontade • 80g de inhame • Peixe ou frango 120g", lanche: "1 kiwi + 8 amêndoas", jantar: "Salada de folhas • Beringela com pimentão • Concha de grão de bico (65g) OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
];
...
export const SEMANA2 = [
  { n: "8º Dia", k: "s2d1",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá detox de louro e cravo", almoco: "Salada de folhas à vontade • 1 concha de grão de bico (65g) • Abobrinha e cenoura à vontade • 80g de batata doce • Peixe ou frango 120g", lanche: "1 maçã + 4 castanhas de caju", jantar: "Salada de folhas • Couve refogada com tomate • 3 colheres de feijão OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "9º Dia", k: "s2d2",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • 1 concha de feijão (65g) • Repolho e cenoura à vontade • 80g de inhame • Peixe ou frango 120g", lanche: "1 pera + 2 castanhas do Pará", jantar: "Salada de folhas • Brócolis grelhado no alho • 3 colheres de lentilha OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "10º Dia", k: "s2d3",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá verde", almoco: "Salada de folhas à vontade • Beringela com pimentão à vontade • 80g de quinoa • Peixe ou frango 120g", lanche: "1 kiwi + 8 amêndoas", jantar: "Salada de folhas • Couve-flor assada • Concha de grão de bico OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  ...
  { n: "12º Dia", k: "s2d5",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • Concha de lentilha (65g) • Chuchu salteado no alho à vontade • 80g de mandioca • Peixe ou frango 120g", lanche: "1 maçã + 5 castanhas de caju", jantar: "Salada de folhas • Abobrinha grelhada • 1 concha de feijão OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "13º Dia", k: "s2d6",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de cavalinha", almoco: "Salada de folhas à vontade • Concha de feijão (65g) • Brócolis e tomate cereja assados à vontade • 80g de batata doce • Peixe ou frango 120g", lanche: "1 pera + 2 castanhas do Pará", jantar: "Salada de folhas • Repolho refogado • 3 colheres de lentilha OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir" } },
  { n: "14º Dia — Celebração 🌹", k: "s2d7",
    ...
    proteina: { cafe: "Shot + suco • Meio da manhã: chá de hibisco", almoco: "Salada de folhas à vontade • Couve-flor e chuchu à vontade • 80g de inhame • Peixe ou frango 120g", lanche: "1 kiwi + 8 amêndoas", jantar: "Salada de folhas • Arroz de couve-flor • Concha de grão de bico OU 3 conchas de sopa • 1 ou 2 ovos", ceia: "Chás para dormir • Pesar, fotografar e escrever o que mudou nestas 2 semanas 💛" } },
];
...
export const CARDAPIO = {
  s3: [
    { n: "Segunda", cafe: "Omelete de 2 ovos com espinafre + 1 fruta + café", almoco: "Salada + frango grelhado 120g + arroz de couve-flor + feijão", lanche: "1 maçã + 4 castanhas de caju", jantar: "Sopa de legumes + 1 ovo cozido" },
